  ...
  return (
    <header className="space-y-2">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <h1 className="text-3xl font-extrabold tracking-tight text-[#191c1e]">{detail.invoice.invoiceCode}</h1>
      ...
      <p className="text-sm font-medium text-[#737784]">
        {detail.invoice.clientName} - <span className="text-[#191c1e]">{detail.clientInfo.projectName}</span>
      </p>
    </header>
  );
};
