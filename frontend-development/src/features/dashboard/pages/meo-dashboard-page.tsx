...
export const MeoDashboardPage = () => {
  ...
  return (
    <div className="space-y-5 pb-10">
      <header>
        <h1 className="text-2xl font-semibold text-[#191c1e]">Dashboard BD Meo</h1>
      ...
      {data ? (
        <MarketingAnalyticsSection marketing={data.marketing} comparisonLabel={data.meta.comparison_label} />
      ) : null}
    </div>
  );
};
